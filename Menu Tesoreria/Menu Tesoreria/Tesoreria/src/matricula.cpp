...
void matricula::datosEstudiante(){
    system("cls");
    fstream file;
      string facultad, nombre, apellido1, apellido2, fechaNacimiento, direccion, telefono, DPI, correo, fecha, numeroBoleta;
      cout<<"\n-----------------------------------------------------------------------------------------------------------------";
      ...
      getline(cin, fecha);
      cout << "\tMonto de la matricula: Q700.00"<<endl;
